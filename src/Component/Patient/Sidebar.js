...
const Sidebar = ({ isOpen, toggle }) => {
  return (
    <nav className={`${isOpen ? 'block' : 'hidden'} lg:block lg:w-52 bg-white h-screen fixed top-0 left-0`}>
      ...
      <ul className="text-[#7F8F98]">
        ...
        <li className="pl-6 p-2 flex"><FaUsers className="w-5 h-6 mr-3"/><span className="cursor-pointer text-sm">Patient</span></li>
